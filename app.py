...
def reply():
    ...
    if bool(user) == False:
        msg = res.message(
            "Hi, thanks for contacting *Sama Al Ramlah Auto Maint*.\nYou can choose from one of the options below: "
        ...
        if option == 0:
            ...
            cakes = ["Car Inspection", "Car AC Services", "WindShield Services",
                     "Minor km Services", "Major km Services", "Battery Change", "Car Dainting", "Engine Services",
                     "Tyre Change"]
        ...
        if option == 0:
            ...
            #try:
            date_time = text.strftime("%m/%d/%Y, %H:%M:%S")
            #except ValueError:
                #isValidDate = False
        ...
        res.message(
            f"Your appointment for *{selected}* has been received and we look forward to see you in the workshop to provide better serivces")
